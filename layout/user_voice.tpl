<link href="/plugin/onlyoffice/resources/css/userVoice.css" rel="stylesheet" media="screen" type="text/css"/>
<div class="onlyoffice-user-voice">
    <h1>{{'UserVoiceTitle'|get_plugin_lang('onlyofficePlugin')}}</h1>
