...
$strings['document_server_url_help'] = "Veuillez spécifier l'adresse de votre serveur ONLYOFFICE Docs ici";
$strings['jwt_secret'] = 'Clé secrète du Serveur de documents';
$strings['jwt_secret_help'] = 'Laisser vide pour désactiver';
...
$strings['formTemplate'] = 'Formulaire PDF';
...
$strings['jwt_header'] = "En-tête d'autorisation";
$strings['jwt_header_help'] = "Laissez vide pour utiliser l'en-tête par défaut";
...
$strings['UserVoiceTitle'] = 'Bienvenue dans ONLYOFFICE Docs !';
$strings['UserVoiceDescription'] = 'Collaborez sur des documents texte, feuilles de calcul, présentations et formulaires dans la structure Chamilo à l'aide d'ONLYOFFICE Docs.';
$strings['LearnMore'] = 'En savoir plus';
$strings['SuggestFeature'] = 'Suggérer une fonctionnalité';
$strings['EmptyJwtWarning'] = 'Pour garantir la sécurité des paramètres importants dans les requêtes ONLYOFFICE Docs, veuillez définir une clé secrète sur la page Paramètres.
Pour en savoir plus, <a target="_blank" style="text-decoration:underline;" href="https://api.onlyoffice.com/docs/docs-api/get-started/how-it-works/security/">cliquez ici</a>.';
$strings['OnlyofficeUnreachable'] = "ONLYOFFICE est inaccessible. Veuillez contacter l'administrateur";
$strings['fileSavedAs'] = 'Fichier enregistré sous';
$strings['fileCreateForbidden'] = 'Création de fichier non autorisée.';
$strings['docsUrlError'] = 'Impossible de se connecter à ONLYOFFICE Docs. Veuillez vérifier que le serveur fonctionne et est accessible.';
$strings['commandServiceError'] = 'Erreur lors de la vérification de CommandService';
$strings['convertServiceError'] = 'Erreur lors de la vérification de ConvertService';
$strings['docsUnknownError'] = "Une erreur inattendue s'est produite lors de la vérification de la connexion";
$strings['invalidSecret'] = "Impossible de se connecter à ONLYOFFICE Docs. Veuillez vérifier que la clé secrète est correcte.";
