...
$strings['document_server_url_help'] = 'Εδώ, προσδιορίστε τη διεύθυνση του διακομιστή ONLYOFFICE Docs σας';
$strings['jwt_secret'] = 'Μυστικό κλειδί';
$strings['jwt_secret_help'] = 'Αφήστε κενό για απενεργοποίηση';
...
$strings['formTemplate'] = 'Φόρμα PDF';
...
$strings['jwt_header_help'] = 'Αφήστε κενό για να χρησιμοποιήσετε την προεπιλεγμένη κεφαλίδα';
...
$strings['UserVoiceTitle'] = 'Καλώς ορίσατε στο ONLYOFFICE Docs!';
$strings['UserVoiceDescription'] = 'Συνεργαστείτε σε έγγραφα, υπολογιστικά φύλλα, παρουσιάσεις και φόρμες εντός της δομής Chamilo χρησιμοποιώντας το ONLYOFFICE Docs.';
$strings['LearnMore'] = 'Μάθετε περισσότερα';
$strings['SuggestFeature'] = 'Προτείνετε μια λειτουργία';
$strings['EmptyJwtWarning'] = 'Για να διασφαλιστεί η ασφάλεια σημαντικών παραμέτρων στα αιτήματα ONLYOFFICE Docs, ορίστε ένα Μυστικό Κλειδί στη σελίδα Ρυθμίσεις.
Για περισσότερες πληροφορίες, <a target="_blank" style="text-decoration:underline;" href="https://api.onlyoffice.com/docs/docs-api/get-started/how-it-works/security/">κάντε κλικ εδώ</a>.';
$strings['OnlyofficeUnreachable'] = 'Δεν είναι δυνατή η πρόσβαση στο ONLYOFFICE. Επικοινωνήστε με τον διαχειριστή';
$strings['fileSavedAs'] = 'Το αρχείο αποθηκεύτηκε ως';
$strings['fileCreateForbidden'] = 'Δεν επιτρέπεται η δημιουργία αρχείου.';
$strings['docsUrlError'] = 'Δεν είναι δυνατή η σύνδεση με το ONLYOFFICE Docs. Ελέγξτε αν ο διακομιστής λειτουργεί και είναι προσβάσιμος.';
$strings['commandServiceError'] = 'Σφάλμα κατά την προσπάθεια ελέγχου του CommandService';
$strings['convertServiceError'] = 'Σφάλμα κατά την προσπάθεια ελέγχου του ConvertService';
$strings['docsUnknownError'] = 'Παρουσιάστηκε απροσδόκητο σφάλμα κατά τον έλεγχο της σύνδεσης';
$strings['invalidSecret'] = 'Δεν είναι δυνατή η σύνδεση με το ONLYOFFICE Docs. Ελέγξτε αν το Μυστικό κλειδί είναι σωστό.';
